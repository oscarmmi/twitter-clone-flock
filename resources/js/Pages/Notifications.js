        ...
        <div class="flex w-full max-w-[1300px] mx-auto">
            ...
            <aside class="w-[72px] xl:w-[275px] flex flex-col items-center xl:items-start p-2 sm:p-4 sticky top-0 h-screen overflow-y-auto shrink-0">
                ...
                <nav class="flex-1 space-y-1 w-full text-zinc-100">
                    ...
                    <a href="/notifications" class="flex items-center space-x-5 p-3 bg-zinc-900/60 rounded-full transition w-fit font-bold text-[#1d9bf0]">
                        ...
                        <div class="p-4 hover:bg-white/[0.03] transition flex space-x-3">
                            ...
                            <div class="flex-1">
                                <div class="flex items-center space-x-2 mb-2">
                                    <img :src="notif.data.user_avatar" class="w-8 h-8 rounded-full" alt="">
                                </div>
                                <div class="text-sm">
                                    <span class="font-bold" x-text="notif.data.user_name"></span> 
                                    <span class="text-zinc-500"> liked your post</span>
                                    <span class="text-zinc-500 text-xs ml-2" x-text="notif.time"></span>
                                </div>
                                <p class="text-zinc-500 text-sm mt-2 line-clamp-2" x-text="notif.data.body"></p>
                            </div>
                        </div>
                    </template>
